...
class GLUtility: NSObject {
    ...
    func getCompressionRatio(actualSize: CGSize, isVideo: Bool, isPortrait:Bool = false) -> CGSize{
        var maxResolution =  imagePreference.MAX_IMAGE_RESOLUTION
        if isVideo {
